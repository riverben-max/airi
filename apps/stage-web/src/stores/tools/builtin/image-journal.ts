...
const generateHeadless = async (_args: any): Promise<{ error?: string; base64?: string; imageUrl?: string }> => { return { error: 'Not implemented in web' } }
const addWidget = async (_args: any): Promise<void> => { return }
