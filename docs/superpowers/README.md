...
| 2026-07-11 | 管理后台上游模型发现 | `in-progress` | [Design](specs/2026-07-11-admin-upstream-model-discovery-design.md) | [Plan](plans/2026-07-11-admin-upstream-model-discovery.md) | - |
