...
<template>
  <button border="2 solid neutral-100/60 dark:neutral-800/30" bg="neutral-50/70 dark:neutral-800/70" w-fit flex items-center self-end justify-center rounded-xl p-2 backdrop-blur-md :title="t('stage.chat.navigation.about')" :aria-label="t('stage.chat.navigation.about')" aria-haspopup="dialog" :aria-expanded="show" @click="show = !show">
